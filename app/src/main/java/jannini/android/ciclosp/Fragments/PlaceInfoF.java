...
public class PlaceInfoF extends Fragment implements OnMapReadyCallback {
    ...
    public static PlaceInfoF newInstance() {
        return new PlaceInfoF();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_place_info, container, false);
        ...
        etEmail = (EditText) fragment.findViewById(R.id.et_place_email);
        ...
        if (AddToMapActivity.functionSelected.equals("EDIT_PLACE")) {
            etName.setText(AddToMapActivity.name);
            etEmail.setText(AddToMapActivity.email);
            etPhone.setText(AddToMapActivity.phone);
            TextView tvFragmentTitle = (TextView) fragment.findViewById(R.id.tv_add_place_info_title);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (AddToMapActivity.location != null) {
            gMap.moveCamera(CameraUpdateFactory.newLatLngZoom(AddToMapActivity.location, 15));
        } else {
        ...
        googleMap.setOnCameraIdleListener(new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                final LatLng mapCenter = gMap.getCameraPosition().target;
                ...
                new AsyncTask<String, Void, String>() {
                    ...
                    protected String doInBackground(String... params) {
                        ...
                        if (!adList.isEmpty()) {
                            ...
                            Log.e("Place Address", String.valueOf(address));
    ...
    public void toFrag2() {
        ...
        if (strName.trim().length() == 0) {
            ...
            mListener.onEIFragmentInteraction(strName, strPhone, strEmail, strAddress, locality, gMap.getCameraPosition().target);
        }
    }
    ...
    public interface OnEIFragmentInteractionListener {
        ...
        void onEIFragmentInteraction(String strName, String strPhone, String strEmail, String strAddress, String locality, LatLng latLng);
    }
}
