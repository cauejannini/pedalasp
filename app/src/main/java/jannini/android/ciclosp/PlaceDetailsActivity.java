...
public class PlaceDetailsActivity extends Activity {
    ...
    int placeId;
    String name, displayServices, address, phone, shortDesc;
    LatLng latLng;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = i.getStringExtra(Constant.IEXTRA_PLACE_NAME);
        categoryIdList = i.getIntegerArrayListExtra(Constant.IEXTRA_PLACE_CATEGORY_ID_LIST);
        ...
        if (shortDesc != null) {tvShortDesc.setText(shortDesc);}
        if (displayServices != null) {tvServices.setText(displayServices);}

        if (!mapCategoriesIcons.isEmpty() && !categoryIdList.isEmpty()) {
        ...
        Calls.getImageForPlaceId(this, placeId, new BitmapCallHandler() {
            @Override
        ...
        Calls.getPlaceOpeningHours(String.valueOf(placeId), new CallHandler(){
            @Override
                    ...
                    alert.setMessage(getString(R.string.confirm_route_to_place_creation))
                            .setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    Intent i = new Intent();
                                    i.putExtra(Constant.IEXTRA_PLACE_LAT_DOUBLE, latLng.latitude);
                                    i.putExtra(Constant.IEXTRA_PLACE_LNG_DOUBLE, latLng.longitude);
                                    i.putExtra(Constant.IEXTRA_PLACE_ADDRESS, address);
